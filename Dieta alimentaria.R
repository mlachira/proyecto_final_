...
#Una tabla equivale a un dÃ­a en el que van a preguntar que comiste de los grupos alimenticios en el desayuno, Colacion 1, comida, colacion 2 y cena
dia_prueba<-function(){
...
#Inserto la fila con la funciÃ³n rbind
