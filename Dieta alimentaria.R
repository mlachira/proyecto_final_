...
dieta_origen_animal<- function(){
  ...
  if(cantidad_de_oa==1){
    ...
    return(print(paste("En alimentos de origen animal las kcal totales son", kcal_totales_oa1, ",las proteínas totales en kcal son", n_proteina_totales_oa1, ", los carbohidratos totales son", n_carbohidratos_totales_oa1, " y las grasas totales son", n_grasas_totales_oa1 )))
