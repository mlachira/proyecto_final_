...
division_calorias <- function(cantidad_calorias){
  print("A lo largo del día, entre comidas y colaciones, se recomienda que consumas...")
  # frutas y verduras
  frutas_y_verduras <- cantidad_calorias/2 # se recomienda que 1/2 de los alimentos en una comida sea de frutas y verduras.
  print (paste (frutas_y_verduras, "calorías de frutas y verduras,"))
  # proteínas y carbohidratos
  proteinas_y_carbs <- cantidad_calorias/4 # se recomienda que 1/4 de los alimentos en una comida sea de proteinas y otro 1/4 de carbohidratos. 
...
division_calorias(cantidad_calorias)
cantidad_calorias
